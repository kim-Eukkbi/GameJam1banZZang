...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float comboColorR = Mathf.Clamp(GameManager.instance.combo / 5, 0.17f, 1);
        float comboColorG = Mathf.Clamp(GameManager.instance.combo / 5, 0.19f, 1);
        float comboColorB = Mathf.Clamp(GameManager.instance.combo / 5, 0.43f, 1);
        GameManager.instance.textCombo.color = new Color(comboColorR, comboColorG, comboColorB);
